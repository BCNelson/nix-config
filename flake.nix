{
  ...
  inputs = {
    ...
    # claude-code is now available in nixpkgs-unstable; keep a separate alias so
    # the overlay can still import it with allowUnfree enabled.
    nixpkgs-claude-code.follows = "nixpkgs-unstable";
