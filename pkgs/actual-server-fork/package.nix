...
let
  ...
  version = "26.2.0-api-tokens";
  src = fetchFromGitHub {
    name = "actualbudget-actual-source";
    owner = "BCNelson";
    repo = "actual";
    rev = "352cbae8f6e00b838ccad0c0695fd1acd1057f94";
    hash = "sha256-+jV6kxpq5rFLxpC/CxkqRbfaKMATGmnGyKTZV3iE/rM=";
  };
...
stdenv.mkDerivation (finalAttrs: {
  ...
  offlineCache = yarn-berry.fetchYarnBerryDeps {
    ...
    hash = "sha256-IKIW5e6e3qTxeY1UxadwYcIjUX/Pye1srEorx7/8QcM=";
  };
  ...
  meta = {
    ...
    description = "Super fast privacy-focused app for managing your finances (BCNelson fork with API tokens)";
