{ inputs, options, lib, ... }:
{
  ...
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-315eae39-8252-48da-956b-8225c30b183e" = [ ];
    ...
    configFile = {
      ...
      "dolphinrc"."ExtractDialog"."3 screens: Height" = 560;
      "dolphinrc"."ExtractDialog"."3 screens: Width" = 1280;
      "dolphinrc"."ExtractDialog"."DirHistory[$e]" = "/run/media/bcnelson/3860-0FBA/AudioBooks/Harry Potter/";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "dolphinrc"."KFileDialog Settings"."detailViewIconSize" = 16;
      "kactivitymanagerdrc"."activities"."315eae39-8252-48da-956b-8225c30b183e" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "315eae39-8252-48da-956b-8225c30b183e";
      ...
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "1969,1038";
      ...
      "kdeglobals"."KScreen"."ScreenScaleFactors" = "DP-2=2;DP-3=2;HDMI-A-1=2;";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{9d686b10-13d5-45d7-81a4-6c325310899e}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{88599f91-a1d4-4773-8301-86c7a01a4002}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{6d0386b8-3978-4d2b-9473-964c44f9779d}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{e9c51611-1f66-459b-a56c-ec7dead8b712}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{5e8361b1-5fad-4f45-becf-378f2b5b3eda}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{512e7b7c-e152-4b2e-ad87-cccff032faa8}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{052e8ad2-9165-463a-bb81-895b02a1a530}";
      ...
      "kwinrc"."Desktops"."Id_1" = "ee98db86-ad38-4887-a1c9-beca16a40953";
      "kwinrc"."Desktops"."Number" = 1;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/0170f1a6-f2f4-5443-91d4-df0973c7a797"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/0c34803f-c4ee-5c24-a478-80a071decc01"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/139e8908-da6c-5a46-acf6-8a7298df9063"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/18e602a3-e7a8-5722-8006-eeb946104f07"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/31cba021-d5d9-5e83-b1c5-dd4a2ed116d6"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/4f0abe9e-ebb7-5809-88b3-0b3e108dd30a"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/4fc9e641-fa52-5822-859a-b9c8c28ffa61"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.4994791666666667},{\"width\":0.5005208333333333}]}";
      "kwinrc"."Tiling/57ba55ac-2aa6-5888-aaef-f24987c0c2a3"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.44635416666666666},{\"width\":0.5536458333333307}]}";
      "kwinrc"."Tiling/649cc80f-b5d3-56ab-846e-a75104b85c42"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/6716b5e8-9f46-544a-8924-76673956970b"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/6c584686-e36f-5849-bb6a-6af514ef736e"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/6c8699e2-4e67-58a7-837d-aa0e6daae343"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/6cf3ff4b-7241-59b1-848a-da9e3d8372b2"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/76187895-0be2-568d-bfa3-dc08af6c94fd"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/99d0cac9-092f-56c5-a173-f6097b166c6d"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/a634d358-d596-5b97-bb25-b94931da58e7"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.75830078125},{\"width\":0.24169921875}]}";
      "kwinrc"."Tiling/b4231fe2-ca54-57de-83ce-e84f9ed7790a"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/ede2f6ca-c47a-5e40-83d6-6f8d97d7a92d"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/f6b2eb01-9909-5208-b732-7b8ea2a46dda"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Xwayland"."Scale" = 1.3;
      "kwinrulesrc"."1"."Description" = "Settings for dolphin-emu";
      "kwinrulesrc"."1"."wmclass" = "dolphin-emu";
      "kwinrulesrc"."1"."wmclassmatch" = 1;
      "kwinrulesrc"."346ddd23-a8bf-4a0e-bd9f-23c11eb10aa9"."Description" = "Window settings for SteamTinkerLaunch-OpenSettings";
      "kwinrulesrc"."346ddd23-a8bf-4a0e-bd9f-23c11eb10aa9"."maxsize" = "700,700";
      "kwinrulesrc"."346ddd23-a8bf-4a0e-bd9f-23c11eb10aa9"."maxsizerule" = 2;
      "kwinrulesrc"."346ddd23-a8bf-4a0e-bd9f-23c11eb10aa9"."title" = "SteamTinkerLaunch-OpenSettings";
      "kwinrulesrc"."346ddd23-a8bf-4a0e-bd9f-23c11eb10aa9"."wmclass" = "yad";
      "kwinrulesrc"."346ddd23-a8bf-4a0e-bd9f-23c11eb10aa9"."wmclasscomplete" = true;
      "kwinrulesrc"."346ddd23-a8bf-4a0e-bd9f-23c11eb10aa9"."wmclassmatch" = 1;
      "kwinrulesrc"."557af89b-b147-462a-8915-5bb6aa86b434"."Description" = "Settings for dolphin-emu";
      "kwinrulesrc"."557af89b-b147-462a-8915-5bb6aa86b434"."wmclass" = "dolphin-emu";
      "kwinrulesrc"."557af89b-b147-462a-8915-5bb6aa86b434"."wmclassmatch" = 1;
      "kwinrulesrc"."68b9fd50-36ba-4d4b-920e-b20864a53f78"."Description" = "Settings for steam_app_";
      "kwinrulesrc"."68b9fd50-36ba-4d4b-920e-b20864a53f78"."screenrule" = 5;
      "kwinrulesrc"."68b9fd50-36ba-4d4b-920e-b20864a53f78"."wmclass" = "steam_app_";
      "kwinrulesrc"."68b9fd50-36ba-4d4b-920e-b20864a53f78"."wmclassmatch" = 2;
