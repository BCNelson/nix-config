...
let
  ...
  # Drop this once rasmus-kirk/nixarr dev branch ships Jellyfin 10.11.9/10.11.10/10.11.11
  # OpenAPI hashes. The nixpkgs bump in flake.lock moved Jellyfin forward first.
  # Track upstream: https://github.com/nix-media-server/nixarr/blob/dev/nixarr/lib/nixarr-py/python-deps.nix
